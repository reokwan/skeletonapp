...
export class SingupPage implements OnInit {
  // Modelo user que permite obtener y setear información para el singup
  singup:any={
    Usuario:"",
    Password:""
  }
  ...
  ingresar(){
    ...
    if(this.validateModel(this.singup)){
      // Se obtiene si existe alguna data de sesión
      this.authenticationSerive.login(this.singup);
    }
    else{
  ...
  registrar(){
    this.createSesionData(this.singup);
  }
  /**
